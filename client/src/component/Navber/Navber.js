    ...
    render() { 
        return ( 
            <div>
                ...
                <Navbar.Brand style={{color:"white"}}>Healthcare Mgmt.</Navbar.Brand>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav.Link className="text-white" href="/bill">Bill</Nav.Link>
                    <NavDropdown title="Login" id="basic-nav-dropdown" className="text-white">
                        <NavDropdown.Item href="/patient/login">Patient</NavDropdown.Item>
                        <NavDropdown.Item href="/doctors/login">Doctor</NavDropdown.Item>
                        <NavDropdown.Item href="/administrator/login">Admin</NavDropdown.Item>
                    </NavDropdown>
                    </Nav>
